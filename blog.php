				...
				if (mysqli_num_rows($result) > 0) {
					while ($row = mysqli_fetch_assoc($result)) {
						...
						if (mysqli_num_rows($result2) > 0) {
							...
							$adminName = 'Exceptional Programmers';
						}
							...
							echo '<div class="clearfix">
                                    <div class="entry-image">
                                        <a href="blog.php?id=' . $postId . '" data-lightbox="image">
                                            <iframe width="150px" height="150px" src="https://www.youtube.com/embed/' . $post . '" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
                                        </a>
                                    </div>';
						}
