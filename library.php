    ...
    <div class="content-wrap" id="start">
        ...
        <div class="container clearfix">
            ...
            <div class="nobottommargin clearfix">
                ...
                <form method="post">
                    ...
                    <div class="form-group">
                        ...
                        <select class="form-control" name="categorie_op" id="categorie_op"
                            ...
                            if (mysqli_num_rows($result) > 0) {
                                ...
                                while ($row = mysqli_fetch_assoc($result)) {
                                    ...
                                    <option <?php if ($row['id'] == $newOp) { ?> selected <?php } ?>
            ...
            <span class="icon-download-alt"></span></a></td>';
                        ...
                        <tr>
                            <td colspan="5" id="end">
                                <div class="text-center"><a href="library.php#start" type="button"
                                        class="btn btn-sm btn-success"><span class="icon-arrow-up"></span></a></div>
                            </td>
                        </tr>
                    </table>
