...
include ("header.php");
?>
<marquee>Hurry Up !! Pursue The Course Of Your Desire.....</marquee>
	...
	<div class="slider-parallax-inner">
		...
		<div class="swiper-container swiper-parent">
			<div class="swiper-wrapper">
				...
				<div class="swiper-slide dark">
					<div class="container clearfix">
						<div class="slider-caption slider-caption-center">
							<h2 data-caption-animate="fadeInUp">Master new skills at your own pace.</h2>
				...
				<div class="swiper-slide dark"
					style="background-image: url('images/slider/Slide1.jpg'); background-position: center top;">
					<div class="container clearfix">
						<div class="slider-caption">
							<h2 data-caption-animate="fadeInUp">Join the StudySync Family </h2>
							<p data-caption-animate="fadeInUp" data-caption-delay="200">We are here for achieve your
								expectations.</p>
						</div>
					</div>
				</div>
			...
			<div class="row clearfix">
				...
				<div class="col-lg-5">
					<div class="heading-block topmargin">
						<h1>Be the StudySync <br>Members</h1>
					</div>
					<p class="lead">We are a group of StudySync Family; our aim is to promote education. If you
						are a student, then contact us to secure your future. We deliver free international standard
						video lectures and content. We are also providing services in Web &amp; Software Development.
					</p>
				</div>

				<div class="col-lg-7">

					<div style="position: relative; margin-bottom: -60px;" class="ohidden" data-height-lg="426"
						data-height-md="567" data-height-sm="470" data-height-xs="287" data-height-xxs="183">
						<img src="images/services/main-fbrowser.jpg" style="position: absolute; top: 0; left: 0;"
			...
			<div class="container clear-bottommargin clearfix">
				...
				<div class="row topmargin-sm clearfix">
					...
					<div class="col-md-4 bottommargin">
						...
						<p>We are here for achieve your expectations. Our professional programmers have care about your
							product. They are positive, willing to go the distance to get the job done and bring their
							best every day.</p>
					</div>
					...
					<div class="col-md-4 bottommargin">
						...
						<p>We have a team for communication with users to inform the status, requirements and guidelines
							about the project in present also in future.</p>
					</div>
					...
					<div class="col-md-4 bottommargin">
						...
						<p>We are highly reliable. Our team have a strong work ethic. An important skill is the ability
							to estimate the amount of time needed to complete a task.</p>
					</div>
		...
		<div class="container clearfix" id="features">
			...
			<div class="row topmargin-lg bottommargin-sm">
				...
				<div class="heading-block center">
					<h2>We are StudySync</h2>
					<span class="divcenter">Our team and instructors have many unique qualities &amp; skills. Dear
						students, We are providing free online learning platform. Where your skills are polished.</span>
				</div>
				...
				<div class="col-md-4 col-sm-6 bottommargin">
					...
					<div class="feature-box fbox-right topmargin" data-animate="fadeIn">
						...
						<p>We have Professional Instructors that deliver video lectures.</p>
					</div>
				...
				<div class="col-md-4 col-sm-6 bottommargin">
					...
					<div class="feature-box topmargin" data-animate="fadeIn">
						...
						<p>We are also providing international standard lectures.</p>
					</div>
		...
		<div class="row clearfix bottommargin-lg common-height">
			...
			<div class="col-md-4 col-sm-6 dark center col-padding" style="background-color: #576F9E;">
				<div>
					...
					<div class="counter counter-lined"><span data-from="2" data-to="20" data-refresh-interval="100"
			...
			<div class="col-md-4 col-sm-6 dark center col-padding" style="background-color: #6697B9;">
				<div>
					...
					<div class="counter counter-lined"><span data-from="1" data-to="10" data-refresh-interval="25"
							data-speed="4000"></span></div>
					<h5>No. of Awards</h5>
				</div>
			</div>
			...
			<div class="col-md-4 col-sm-6 dark center col-padding" style="background-color: #88C3D8;">
				<div>
					...
					<div class="counter counter-lined"><span data-from="1" data-to="50" data-refresh-interval="30"
					...
					<div class="slider-wrap">
						<div class="slide">
							...
							<div class="testi-content">
								<p>We don&#39;t build services to make money&#59; we make money to build better services
								</p>
