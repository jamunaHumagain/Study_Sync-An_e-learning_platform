		...
		<section id="content">
			...
			<div class="content-wrap nopadding">
				...
				<div class="section nopadding nomargin"
					style="width: 100%; height: 100%; position: absolute; left: 0; top: 0; background: url('../images/login.png') center center no-repeat; background-size: cover;">
				</div>
				...
				<div class="section nobg full-screen nopadding nomargin">
					<div class="container vertical-middle divcenter clearfix">
						...
						<!-- <div class="row center">
							<a href="index.php"><img height="0%" width="8%" src="../images/logo-footer1.png"
									alt="Study Sync "></a>
						</div> -->
						...
						<div class="row center dark"><small>Copyrights &copy; 2024 All Rights Reserved by
								StudySync.</small>
						</div>
