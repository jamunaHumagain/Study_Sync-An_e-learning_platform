...
if ((!isset($_SESSION['userId']) && empty($_SESSION['userId'])) && (!isset($_SESSION['userName']) && empty($_SESSION['userName']))) {
    ...
    if (isset($_GET['id'])) {
        ...
        if ($power == 'yes') {
            ...
            header('Location: courses.php?back=1');
                        ...
                        <form action="" method="post" enctype="multipart/form-data">
                            <div class="form-group">
                                ...
                                <input type="text" id="nameID" placeholder="Full Name"
                                    value="<?php if (isset($coursename))
                                        echo $coursename; ?>" name="fullname"
                                ...
                                <select class="form-control" name="book_op">
                                    ...
                                    if (mysqli_num_rows($result) > 0) {
                                        ...
                                        while ($row = mysqli_fetch_assoc($result)) {
                                            ...
                                            <option <?php if ($row['id'] == $coursBook) { ?> selected <?php } ?>
                                ...
                                <select class="form-control" name="categorie_op">
                                    ...
                                    if (mysqli_num_rows($result) > 0) {
                                        ...
                                        while ($row = mysqli_fetch_assoc($result)) {
                                            ...
                                            <option <?php if ($row['id'] == $coueseCategorie) { ?> selected <?php } ?>
                            ...
                            <div class="form-group">
                                ...
                                <select class="form-control" name="ins_op">
                                    ...
                                    if (mysqli_num_rows($result) > 0) {
                                        ...
                                        while ($row = mysqli_fetch_assoc($result)) {
                                            ...
                                            <option <?php if ($row['id'] == $courseInstr) { ?> selected <?php } ?>
                                                value="<?php echo $row['id']; ?>"> <?php echo $row['name']; ?> </option>
                                ...
                                <?php if (isset($instructor_error))
                                    echo $instructor_error; ?>
                            </div>

                            <div class="form-group">
                                <img src="images/courses/<?php if (isset($coursePic))
                                    echo $coursePic; ?>" width="100px"
                                    height="100px">
                            </div>
                            <div class="form-group">
                            ...
                            <input type="hidden" value="<?php if (isset($coursePic))
                                echo $coursePic; ?>" name="picValue" />


                            <div class="form-group">
                                <label for="descriptionId1">Description</label>
                                <textarea id="descriptionId1" class="form-control"
                                    name="description"><?php if (isset($courseDescription))
                                        echo $courseDescription; ?></textarea>
                            </div>
