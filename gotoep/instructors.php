...
if ((!isset($_SESSION['userId']) && empty($_SESSION['userId'])) && (!isset($_SESSION['userName']) && empty($_SESSION['userName']))) {
    ...
    if (isset($_GET['delid'])) {
        ...
        if ($power == 'yes') {
            ...
            $alertMessage = "<div class='alert alert-danger'> 
                <p>Are you sure want to delete this Record? No take back!</p><br>
        ...
        <section id="content">
            ...
            <div class="content-wrap">
                    ...
                    <div class="postcontent nobottommargin">
                        ...
                        <form action="" method="post" enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" id="fullnameId1" placeholder="Full Name" name="fullname"
                            ...
                            <div class="form-group">
                                ...
                                <input type="email" id="emailid1" placeholder="Email" name="email" class="form-control"
                            ...
                            <div class="form-group">
                                ...
                                <input type="tex" id="qualificationId1" placeholder="Qualifications" name="qualification"
                                    class="form-control">
                ...
                <span class="icon-trash2"></span></a></td>';
                            ...
                            <tr>
                                <td colspan="9" id="end">
                                    <div class="text-center"><a href="instructors.php" type="button"
