        ...
        <section id="content">
            ...
            <div class="content-wrap">
                            ...
                            if (mysqli_num_rows($result) > 0) {
                                ...
                                while ($row = mysqli_fetch_assoc($result)) {
                                    ...
                                    if ($row["status"] == 'image') {
                                        ...
                                        <td width="80" height="80"> <iframe width="80px" height="80px"
                                                src="https://www.youtube.com/embed/<?php echo $row['post']; ?>"
                ...
                <span class="icon-trash2"></span></a></td>';
                            ...
                            <tr>
                                <td colspan="7" id="end">
                                    <div class="text-center"><a href="blog.php" type="button"
                ...
                if (select == 'video') {
                    document.getElementById('data').innerHTML =
                        `<div class="form-group">
                                ...
                                <input type="text" id="linkID1" placeholder="Link" name="link" class="form-control">
                            </div>
