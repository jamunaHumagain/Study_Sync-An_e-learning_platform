...
if ((!isset($_SESSION['userId']) && empty($_SESSION['userId'])) && (!isset($_SESSION['userName']) && empty($_SESSION['userName']))) {
    ...
    if (isset($_GET['id'])) {
        ...
        if ($power == 'yes' || $loginId == $adminId) {
            ...
            header('Location: home.php?back=1');
                    ...
                    <div class="postcontent nobottommargin">
                        ...
                        <form action="" method="post" enctype="multipart/form-data">
                            <div class="form-group">
                                ...
                                <input type="text" id="nameId" placeholder="Full Name"
                                    value="<?php if (isset($adminName))
                                        echo $adminName; ?>" name="fullname"
                            ...
                            <div class="form-group">
                                ...
                                <select class="form-control" name="admin_op">
                                    ...
                                    <option <?php if ($adminType == 'yes') { ?> selected <?php } ?> value="yes">Yes
                                        Sophisticated</option>

                                    <option <?php if ($adminType == 'no') { ?> selected <?php } ?> value="no">Not Sophisticated
                                    </option>
                            ...
                            <div class="form-group">
                                ...
                                if (isset($adminMail))
                                    echo $adminMail; ?>" name="email" class="form-control"
                                    title="someone@example.com" pattern="[a-z0-9._%+-]+@[a-z0-9.-]+\.[a-z]{2,4}$">
                                <?php if (isset($message_email)) {
                                    echo $message_email;
                                } ?>
                            </div>
                            <div class="form-group">
                                <img src="images/admin/<?php if (isset($adminPic))
                                    echo $adminPic; ?>" width="100 px"
                                    height="100 px">
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <input type="password" id="passwordId1" placeholder="Password" name="password"
                            ...
                            <div class="form-group">
                                ...
                                <input type="password" id="passwordid2" placeholder="Confirm Password" name="c_password"
                                    class="form-control" required minlength="6">
                                <?php if (isset($message_c_pass)) {
                                    echo $message_c_pass;
                                } ?>
                            </div>

                            <input type="hidden" value="<?php if (isset($adminPic))
                                echo $adminPic; ?>" name="picValue" />
                            <div class="form-group">
