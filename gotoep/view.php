            ...
            <div class="container clearfix">
                ...
                <nav>
                    <ul>
                        ...
                        <li <?php if (isset($_GET['courseId'])) { ?> class="current" <?php } ?>><a href="courses.php"><i
                                    class="icon-book3"></i>Courses</a></li>

                        <li <?php if (isset($_GET['id'])) { ?> class="current" <?php } ?>><a href="content.php"><i
                                    class="icon-line-content-left"></i>Content</a> </li>

                        <li><a href="blog.php"><i class="icon-blogger"></i>Blog</a></li>

                        <li <?php if (isset($_GET['libId'])) { ?> class="current" <?php } ?>><a href="library.php"><i
                                    class="icon-line-align-center"></i>Library</a></li>

                        <li <?php if (isset($_GET['instructorId'])) { ?> class="current" <?php } ?>><a
                                href="instructors.php"><i class="icon-guest"></i>Instructors</a></li>
