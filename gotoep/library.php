        ...
        <section id="content">
            ...
            <div class="content-wrap">
                    ...
                    <div class="postcontent nobottommargin">
                        ...
                        <form method="post" enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" id="fullnameId" placeholder="Full Name" name="fullname"
                            ...
                            <div class="form-group">
                                ...
                                <textarea id="descriptionId" class="form-control" name="description"></textarea>
                            </div>
                ...
                <span class="icon-trash2"></span></a></td>';
                            ...
                            <tr>
                                <td colspan="6" id="end">
                                    <div class="text-center"><a href="library.php" type="button"
