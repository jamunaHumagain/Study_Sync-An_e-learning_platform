...
if ((!isset($_SESSION['userId']) && empty($_SESSION['userId'])) && (!isset($_SESSION['userName']) && empty($_SESSION['userName']))) {
    ...
    if (isset($_GET['id'])) {
        ...
        if ($power == 'yes') {
            ...
            header('Location: library.php?back=1');
                    ...
                    <div class="postcontent nobottommargin">
                        ...
                        <form method="post" enctype="multipart/form-data">
                            <div class="form-group">
                                ...
                                <input type="text" id="fullnameId" value="<?php if (isset($bookName))
                                    echo $bookName; ?>"
                                    placeholder="Full Name" name="fullname" class="form-control"
                                    title="Only lower and upper case and space" pattern="[A-Za-z/\s]+">
                            ...
                            <div class="form-group">
                                <img src="images/library/<?php if (isset($coverPic))
                                    echo $coverPic; ?>" width="100px"
                                    height="100px">
                            </div>
                                ...
                                <select class="form-control" name="categorie_op">
                                    ...
                                    if (mysqli_num_rows($result) > 0) {
                                        ...
                                        while ($row = mysqli_fetch_assoc($result)) {
                                            ...
                                            <option <?php if ($row['id'] == $bookCategorie) { ?> selected <?php } ?>
                                                value="<?php echo $row['id']; ?>"> <?php echo $row['categorie']; ?> </option>
                ...
                <span class="icon-eye-open"></span></a>'; ?>
                            ...
                            <div class="form-group">
                                <label class="btn btn-success" for="my-file-selector1">
                                    <input id="my-file-selector1" name="file1" type="file" style="display:none;"
                            ...
                            <div class="form-group">
                                ...
                                <textarea id="descriptionId" class="form-control"
                                    name="description"><?php if (isset($bookDescription))
                                        echo $bookDescription; ?></textarea>
                            </div>
                            <?php if (isset($message_des)) {
                                echo $message_des;
                            } ?>

                            <input type="hidden" name="pdfValue" value="<?php if (isset($bookPdf))
                                echo $bookPdf; ?>">

                            <input type="hidden" value="<?php if (isset($coverPic))
                                echo $coverPic; ?>" name="picValue" />

                            <div class="form-group">
                                <button name="submit" class="btn btn-block btn-success" onclick="uploadFile()"
