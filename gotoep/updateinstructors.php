...
if ((!isset($_SESSION['userId']) && empty($_SESSION['userId'])) && (!isset($_SESSION['userName']) && empty($_SESSION['userName']))) {
    ...
    if (isset($_GET['id'])) {
        ...
        if ($power == 'yes') {
            ...
            header('Location: instructors.php?back=1');
    ...
    <div id="wrapper" class="clearfix">
        ...
        <section id="page-title">
            ...
            <div class="container clearfix">
                <h1>Welcome <strong><?php if (isset($loginName))
                    echo $loginName; ?></strong></h1>
            </div>
                    ...
                    <div class="postcontent nobottommargin">
                        ...
                        <form action="" method="post" enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" id="fullnameId1" placeholder="Full Name"
                                    value="<?php if (isset($teacherName))
                                        echo $teacherName; ?>" name="fullname"
                                    class="form-control" title="Only lower and upper case and space" pattern="[A-Za-z/\s]+">
                            ...
                            <div class="form-group">
                                ...
                                <input type="email" id="emailId1" placeholder="Email"
                                    value="<?php if (isset($teacherMail))
                                        echo $teacherMail; ?>" name="email"
                                    class="form-control" title="someone@example.com"
                            ...
                            <div class="form-group">
                                <img src="images/instructor/<?php if (isset($teacherPic))
                                    echo $teacherPic; ?>" width="100px"
                                    height="100px">
                            </div>

                            <div class="form-group">
                                <label class="btn btn-success" for="my-file-selector">
                                    <input id="my-file-selector" name="profilePic" type="file" style="display:none;"
                                        onchange="$('#upload-file-info').html($(this).val());">
                                    Profile Picture
                                </label>
                                <span class='label label-success' id="upload-file-info"></span>
                                <?php if (isset($message_picture)) {
                            ...
                            <div class="form-group">
                                ...
                                <input type="tex" id="qualificationid1" placeholder="Qualifications"
                                    value="<?php if ($teacherqualification)
                                        echo $teacherqualification; ?>"
                                    name="qualification" class="form-control">
                                <?php if (isset($message_q)) {
                                    echo $message_q;
                                } ?>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" id="phoneId1" placeholder="Phone"
                                    value="<?php if (isset($teacherPhone))
                                        echo $teacherPhone; ?>" name="phone"
                                    class="form-control">
                                <?php if (isset($message_ph)) {
                                    echo $message_ph;
                                } ?>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <textarea id="descriptionId1" placeholder="Description" class="form-control"
                                    name="description"><?php if (isset($teacherdes))
                                        echo $teacherdes; ?></textarea>
                            </div>
                            <?php if (isset($message_des)) {
                                echo $message_des;
                            } ?>
                            <input type="hidden" value="<?php if (isset($teacherPic))
                                echo $teacherPic; ?>"
                                name="picValue" />
                            <div class="form-group">
