...
if ((!isset($_SESSION['userId']) && empty($_SESSION['userId'])) && (!isset($_SESSION['userName']) && empty($_SESSION['userName']))) {
    ...
    if (isset($_GET['id'])) {
        ...
        if ($power == 'yes') {
            ...
            header('Location: content.php?back=1');
                    ...
                    <div class="postcontent nobottommargin">
                        ...
                        <form action="" method="post" enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" id="nameId1"
                                    value="<?php if (isset($content_Name))
                                        echo $content_Name; ?>" placeholder="Lecture Name"
                                    name="name" class="form-control" title="Only lower and upper case and space"
                                    pattern="[A-Za-z/\s]+">
                                ...
                                <select class="form-control" name="course_op" id="contentsel">
                                    ...
                                    if (mysqli_num_rows($result) > 0) {
                                        ...
                                        while ($row = mysqli_fetch_assoc($result)) {
                                            ...
                                            <option <?php if ($row['id'] == $course_Id) { ?> selected <?php } ?>
