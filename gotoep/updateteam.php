...
if ((!isset($_SESSION['userId']) && empty($_SESSION['userId'])) && (!isset($_SESSION['userName']) && empty($_SESSION['userName']))) {
	...
	if (isset($_GET['id'])) {
		...
		if ($power == 'yes') {
			...
			header('Location: team.php?back=1');
						...
						<form action="" method="post" enctype="multipart/form-data">
							...
							<div class="form-group">
								...
								<input type="text" id="fullnameId1" placeholder="Full Name"
									value="<?php if (isset($memberName))
										echo $memberName; ?>" name="fullname"
							...
							<div class="form-group">
								<img src="images/team/<?php if (isset($memberPic))
									echo $memberPic; ?>" width="100px"
									height="100px">
							</div>
							...
							<div class="form-group">
								...
								<input type="tex" id="qualificationid1" placeholder="Qualifications"
									value="<?php if ($memberQualification)
										echo $memberQualification; ?>"
							...
							<input type="hidden" value="<?php if (isset($memberPic))
								echo $memberPic; ?>" name="picValue" />
							<div class="form-group">
