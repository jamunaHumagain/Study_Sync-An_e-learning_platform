    ...
    if (isset($_GET['delid'])) {
        ...
        if ($power == 'yes') {
            ...
            if ($deluser != 1) {
                ...
                $alertMessage = "<div class='alert alert-danger'> 
            <p>Are you sure want to delete this Admin? No take back!</p><br>
        ...
        <section id="content">
            ...
            <div class="content-wrap">
                    ...
                    <div class="postcontent nobottommargin">
                        ...
                        <form action="" method="post" enctype="multipart/form-data">
                            <div class="form-group">
                                ...
                                <input type="text" id="nameId" placeholder="Full Name" name="fullname" class="form-control"
                            ...
                            <div class="form-group">
                                ...
                                <input type="email" id="emailId" placeholder="Email" name="email" class="form-control"
                            ...
                            <div class="form-group">
                                ...
                                <input id="passwordId2" type="password" placeholder="Confirm Password" name="c_password"
                                    class="form-control" required minlength="6">
                ...
                <span class="icon-trash2"></span></a></td>';
                            ...
                            <tr>
                                <td colspan="6" id="end">
                                    <div class="text-center"><a href="home.php" type="button"
                                            class="btn btn-sm btn-success"><span class="icon-plus"></span></a></div>
                                </td>
                            </tr>
                        </table>
